...
const Post = ({tweet, currentUserId, formatDate, handleLikePost, setRespondingTo, respondingTo, sendResponse, handleLikeResponse, responseText, setResponseText, setTweets}) => {
  return (
    <div className='user-post-container' key={tweet.id}>
