...
const ProfileContent = () => {
    ...
    async function getMyPosts() {
        ...
        setLoading(true)
        try {
            const response = await fetch(`/api/user-posts?username=${username}&page=${page}`, {
                method: "GET",
                headers: { 
    ...
    async function getLikedPosts() {
        ...
        setLoading(true)
        try {
            const response = await fetch(`/api/liked-posts?username=${username}&page=${page}`, {
                method: "GET",
                headers: { 
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${token}`
    ...
    async function getMyResponses() {
        ...
        try {
            const response = await fetch(`/api/user-responses?username=${username}&page=${page}`, {
                method: "GET",
                headers: { 
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${token}`
